...
//        $MERCHANT_KEY = "K97oTaDC";      //test
        $MERCHANT_KEY = "0EvqkT";
        // Merchant Salt as provided by Payu
//        $SALT = "wCA58bY37Q";      //test
        $SALT = "5XGCurol";
...
//                debug($save_data);
                ...
                if ($this->PatientPackageLog->save($save_data)) {
                    ...
                    $message = "Dear " .$details['user_name']. ", you have ordered a plan" . $details['package_name'] ." for ". $details['price'] ." on ". date('d-M-Y h:i:s A',strtotime($details['created'])) ." Please call on 01204164011 for help.";
