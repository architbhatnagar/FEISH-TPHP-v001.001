            ...
            if (!empty($users)) {
                ...
                if ($this->request->is(array('post', 'put'))) {
                    ...
                    if ($this->User->save($this->request->data)) {
                        ...
                        $email1->to('siddiqui.azhar@gmail.com');
...
//            if ($this->User->saveAssociated($data)) {
    ...
    public function test_sms() {
        ...
        $url = "http://bulksms.mysmsmantra.com:8080/WebSMS/SMSAPI.jsp?username=feishtest&password=210295899&sendername=FEISHT&mobileno=9096805292&message=" . urlencode($message);
    ...
    public function contact() {
        ...
        if ($this->request->is('post')) {
            ...
            if (!empty($this->request->data['Contact']['email'])) {
                ...
                $email->to('yogesh.more@codaemonsoftwares.com');
...
//                return $this->redirect(array('action' => 'view', $id, $user_type));
    ...
    public function beforeFilter() {
        $this->Auth->allow(array('logout', 'forgot_password', 'login', 'add', 'index', 'homepage', 'sign_up', 'check_mail_id', 'check_mobile', 'verify_account', 'check_user', 'test', 'terms_and_conditions', 'user_faq','test_sms', 'new_homepage', 'contact','myfaq','news','ajaxNewsletter'));
