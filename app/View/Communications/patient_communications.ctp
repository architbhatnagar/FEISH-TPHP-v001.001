                            ...
                            <div class="box-body">
                                ...
                                <div class="section-content">
                                    <header id="filters" class="panel-heading tab-bg-dark-navy-blue">
                                        <ul class="nav nav-pills nav-justified" style="background-color: #ECECEC;">
                                            <li class="active"><a data-toggle="tab" href="#ptop_msg">Patient to Patient</a></li>
                                            <li class="">
                                ...
                                <div class="panel-body">
                                    <div class="tab-content tasi-tab">
                                        <div class="row tab-pane active" id="ptop_msg">
                                                                ...
                                                                <table class="table table table-inbox table-hover ">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th><?php echo $this->Paginator->sort('Reciever.first_name', 'Patient'); ?></th>
                                        ...
                                        <div class = "row tab-pane" id = "ptodr_msg" hidden>
                                            <div class = "col-md-12 col-sm-12 col-xs-12">
                                                <div class = "box">
                                                    <br/>
                                                    <div class="box-body">
                                                        <?php if (!empty($communications)) { ?>
                                                            <div class="desc">
                                                                <table class="table table table-inbox table-hover ">
                                                                    ...
                                                                    <tbody>
                                                                        <?php foreach ($communications as $message): ?>
                                                                            <?php if ($message['Communication']['message_type'] == 2): ?>
                                                                                <?php
                                                                                if ($message['Communication']['is_viewed'] == 0):
