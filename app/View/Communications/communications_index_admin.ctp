<div class="col-sm-12">
    <ul class="breadcrumbs-alt">
        ...
        <li>
            <a class="current" href="javascript:void(0);">Communications</a>
        </li>
        <li class="pull-right">
    ...
    <section class="panel">
        <header class="panel-heading">
            ...
            <div class="pull-right" style="margin-top: -6px;">
                <button class="btn btn-sm btn-danger" onclick="javascript:window.location.href = '<?= Router::url(array('controller' => 'communications', 'action' => 'compose_message')) ?>'"><i class="fa fa-envelope"></i> Compose</button>
            </div>
                 */   ?>
        </header>
                    ...
                    <tbody>
                        ...
                        if (count($communications) > 0) {
                            foreach ($communications as $message):
                                ...
                                <tr class="<?= $tr_class ?>">
                                    <td>
                                        <a href="<?= Router::url(array('controller' => 'communications', 'action' => 'view_admin_communication', $message['Communication']['id'])); ?>">
                                            <strong>  
        <?=
