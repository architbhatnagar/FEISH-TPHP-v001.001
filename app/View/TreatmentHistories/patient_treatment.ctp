        ...
        <div class=" col-sm-12 bhoechie-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
                <div class="list-group">
                    ...
                    <a href="<?= Router::url(array('controller' => 'treatment_histories', 'action' => 'patient_treatment', $user['User']['id'], $user['User']['user_type'])) ?>" class="list-group-item active text-center">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php if(Authcomponent::user('user_type') != 1) { ?>
                                <?php echo $this->HTML->link(__('<i class="fa fa-medkit"></i> Add Treatment'), array('action' => 'patient_add_treatment', $id, $user_type), array('id' => 'add_treatment', 'escape' => false, 'class' => 'btn btn-danger btn-sm pull-right', 'style' => 'margin-top: -55px;')); ?>
                            <?php } ?>
                                    ...
                                    if (count($treatmentHistories) > 0) {
                                        foreach ($treatmentHistories as $treatmentHistory):
                                            ...
                                            <tr>
                                                ...
                                                <td class="actions">
                                                    <?php echo $this->Form->button(__('<i class="fa fa-search"></i>'), array('escape' => false, 'title' => 'View', 'data-toggle' => 'modal', 'data-target' => '#treatmentdetails_' . $treatmentHistory['TreatmentHistory']['id'], 'class' => 'treatment_details btn btn-warning btn-xs')); ?>
                                                    <?php if(Authcomponent::user('user_type') != 1) { ?>
