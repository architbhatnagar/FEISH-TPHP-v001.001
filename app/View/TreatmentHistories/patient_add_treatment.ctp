                ...
                <div class="bhoechie-tab-content">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php echo $this->HTML->link(__('<i class="fa fa-medkit"></i>Treatment List'), array('action' => 'patient_treatment', $id, $user_type), array('id' => 'add_treatment', 'escape' => false, 'class' => 'btn btn-danger btn-sm pull-right', 'style' => 'margin-top: -55px;')); ?>
                                    ...
                                    <div class="row">
                                        <div class="treatmentHistories form col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <?php echo $this->Form->radio('is_running', array('1' => ' Yes', '0' => ' No'), array('data-bvalidator' => 'required', 'id' => 'is_running_0', 'label' => false, 'legend' => false, 'separator' => ' &nbsp;&nbsp;', 'onclick' => 'show_end_date(this);')); ?>
                                                </div>
                                            </div>
                                            <div class="form-group">
