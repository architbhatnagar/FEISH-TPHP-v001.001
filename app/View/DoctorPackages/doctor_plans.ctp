                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <span class="tools pull-right">
                            <a aria-expanded="false" data-toggle="collapse" data-parent="#accordion" href="#collapse_0" class="fa fa-chevron-up collapsed"></a>
                        </span>
                    </header>
...
//                                                        foreach ($plan_details as $value) :
                                                    ...
                                                    <div class="price-actions">
                                                        <a href="<?= Router::url(array('controller' => 'doctor_packages', 'action' => 'view', $plan['DoctorPackage']['id'])); ?>" class="btn">Buy</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
