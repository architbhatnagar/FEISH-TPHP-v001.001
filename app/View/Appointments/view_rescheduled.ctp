                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="box last">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="doctor-info">
                                            <nav id="filters" class="doctor-cate-menu">
                                                <ul class="nav nav-pills nav-justified">
                                                    ...
                                                    <li class="show_selected active"><a>Rescheduled</a></li>
                                                    <li class="show_selected">
                                    ...
                                    <div class = "row all_tab_cls" id = "rescheduled">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($appointments as $key => $value) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo date('d-M-Y \a\t h:i a', strtotime($value['Appointment']['scheduled_date'])); ?></td>
                                                                            <td>
                                                                                <div class="pull-right">
                                                                                    ...
                                                                                    <?php if (time() > strtotime($value['Appointment']['scheduled_date'])) { ?>
                                                                                        <a data-content="Report" data-placement="top" data-trigger="hover"  href="<?= Router::url(array('controller' => 'appointments', 'action' => 'view_report_details', $value['Appointment']['id'])) ?>" class="btn btn-xs btn-info no-upper" title="Reports"><i class="fa fa-pencil"></i></a>
                                                                                        ...
                                                                                        <?php echo $this->Html->link(__('<i class="fa fa-file"></i>'), array('action' => 'add_drugs_by_patient', $value['Appointment']['id'], 2), array('escape' => false, 'data-content' => "Add Drugs", 'data-placement' => "bottom", 'data-trigger' => "hover", 'class' => "popovers btn btn-xs btn-success btn-sm", 'title' => 'Add Drug')); ?>
                                                            ...
                                                            <table class="table table-bordered">
                                                                <tbody> 
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class=""> 
                                                                                <strong>Schedule Date - </strong> <?php echo date('d-M-Y h:i A', strtotime($value['Appointment']['scheduled_date'])); ?>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
