<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumbs-alt">
            ...
            <li>
                <a class="current" href="">Previous Drug</a>
            </li>
        </ul>
        <section class="panel">
                    ...
                    <div class="panel-body invoice">
                        <div class="row invoice-to">
                            ...
                            <div class="col-lg-4 pull-right">
                                <?php echo $this->Html->link(__('<i class="fa fa-arrow-circle-left"></i> Back'), array('action' => 'index'), array('escape' => false, 'class' => "pull-right btn btn-sm btn-success")); ?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 payment-method">
                                <?php echo $this->Form->input($i.'.things_to_do', array('value' => $prescription[0]['Prescription']['things_to_do'], 'type' => 'textarea', 'placeholder' => "Add important instruction", 'rows' => '5', 'class' => 'ckeditor form-control', 'div' => false, 'label' => false)); ?>
                            </div>
                        </div>
                        <?php } ?>
                        <br>
                        ...
                        <div>
                        <a data-content="Report" data-placement="top" data-trigger="hover"  href="<?= Router::url(array('controller' => 'appointments', 'action' => 'print_drugs_prescription',$appointment_id)) ?>" class="btn btn-info pull-right" target="_blank"><i class="fa fa-file-excel-o"></i> Print</a>
                        </div>
                        <?php } ?>
                    </div>
                </section>
