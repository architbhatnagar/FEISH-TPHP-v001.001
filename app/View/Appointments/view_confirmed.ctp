                                        ...
                                        <div class="doctor-info">
                                            <nav id="filters" class="doctor-cate-menu">
                                                <ul class="nav nav-pills nav-justified">
                                                    <li class="show_selected " tab_id="booked">
                                                        <?php echo $this->Html->link(__('Booked'), array('action' => 'view_all')); ?>
                                                        <!--                                                        <a>Booked</a>-->
                                                    </li>
                                                    <li class="show_selected active">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($appointments as $key => $value) { //debug($value); die;
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php
                                                                                if ($value['Appointment']['status'] == 2) {
                                                                                    echo date('d-M-Y \a\t h:i a', strtotime($value['Appointment']['scheduled_date']));
                                                                                } else {
                                                                                    if(!empty($value['Appointment']['scheduled_date'])) {
                                                                                        echo date('d-M-Y \a\t h:i a', strtotime($value['Appointment']['scheduled_date']));
                                                                                    }else {
                                                                            ...
                                                                            <td>
                                                                                <?php
                                                                                if ($value['Appointment']['status'] == 2) {
                                                                                    $appointment_time = strtotime($value['Appointment']['scheduled_date']);
                                                                                } else if ($value['Appointment']['status'] == 1) {
                                                                                    $appointment_time = strtotime($value['Appointment']['appointed_timing']);
                                                                                }
                                                                                ?>
                                                                                <div class="pull-right">
                                                                                    ...
                                                                                    <?php if (time() > $appointment_time) { ?>
                                                                                        <a title="Reports" data-content="Report" data-placement="top" data-trigger="hover"  href="<?= Router::url(array('controller' => 'appointments', 'action' => 'view_report_details', $value['Appointment']['id'])) ?>" class="btn btn-xs btn-info no-upper"><i class="fa fa-pencil"></i></i> </a>
                                                                                        ...
                                                                                        <?php
                                                                                        if (date('d-M-Y', strtotime($value['Appointment']['appointed_timing'])) <= date('d-M-Y')) {
                                                                                            echo $this->Html->link(__('<i class="fa fa-file"></i>'), array('action' => 'add_drugs_by_patient', $value['Appointment']['id'], 1), array('escape' => false, 'data-content' => "Add Drugs", 'data-placement' => "bottom", 'data-trigger' => "hover", 'class' => "popovers btn btn-xs btn-success btn-sm", 'title' => 'Add Drug'));
                                                                                        } else {
                                                                                            ?>
                                                                                            <a href="javascript:void(0)" class = "popovers btn btn-xs btn-success btn-sm" title="Add Drug"><i class="fa fa-file"></i></a>
                                                                                        <?php }
                                                                                        ?>
                                                                                        ...
                                                                                        <a href="javascript:void(0)" onclick="display('<?= $value['Appointment']['id']; ?>')" class="btn btn-xs btn-warning no-upper" title="Upload Document"><i class="fa fa-upload"></i> </a>
                                                                                        <?php // if (!empty($value['Appointment']['upload_drugs'])) { ?>
                                                                                            <a title="Uploaded Documents" class="btn btn-xs btn-danger no-upper" href="<?= Router::url(array('controller' => 'appointments', 'action' => 'view_documents_list', $value['Appointment']['id'])) ?>" class="download_pdf popovers" data-content="Download">
                                                                                                <i class="fa fa-upload"></i>
                                                                                            </a>
                <!--                                                                                        <a title="Download Documents" class="btn btn-xs btn-danger no-upper" href="<?= Router::url(array('controller' => 'appointments', 'action' => 'download_sample_file', $value['Appointment']['upload_drugs'])) ?>" class="download_pdf popovers" data-content="Download">
                                                                                                <i class="fa fa-upload"></i>
                                                                                            </a>-->
                                                                                        <?php } ?>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class=""> 
                                                                                ...
                                                                                <?php
                                                                                if ($value['Appointment']['status'] == 1) {
                                                                                    if(!empty($value['Appointment']['scheduled_date'])){
                                                                                        echo date('d-M-Y h:i A', strtotime($value['Appointment']['scheduled_date']));
                                                                                    } else {
                                                                                    echo date('d-M-Y h:i A', strtotime($value['Appointment']['appointed_timing']));
                                                                                    }
                                                                                } else if ($value['Appointment']['status'] == 2) {
                                                                                    echo date('d-M-Y h:i A', strtotime($value['Appointment']['scheduled_date']));
                                                                                }
                                                                                ?>
                                                                            </div>
