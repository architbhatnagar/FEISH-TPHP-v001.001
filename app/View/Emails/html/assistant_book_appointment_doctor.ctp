  ...
  <tbody>
    <tr>
      <td>
        ...
        <p>
            Your assistant <?= $salutations[AuthComponent::user('salutation')].". ".ucfirst(AuthComponent::user('first_name'))." ".ucfirst(AuthComponent::user('last_name'))?>
            booked appointment for user <strong> <?= $salutations[$appointment_data['User']['salutation']]." ".ucfirst($appointment_data['User']['first_name'])." ".ucfirst($appointment_data['User']['last_name']); ?>
            </strong>
