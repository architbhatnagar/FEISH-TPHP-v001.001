  ...
  <tbody>
    <tr>
      <td>
        ...
        <?php if($update_by==2):?>
        <p>
            The appointment ID:<strong><?= 'APT-'.$appointment_data['Appointment']['id']?></strong> of patient 
            <?= $salutations[$appointment_data['User']['salutation']].". ".ucfirst($appointment_data['User']['first_name'])." ".ucfirst($appointment_data['User']['last_name'])." (ID: ".'PA-'.$appointment_data['User']['registration_no'].")"?>
            has been <strong><?= $appointment_status[$appointment_data['Appointment']['status']]; ?></strong> by doctor <?= $salutations[$appointment_data['Doctor']['salutation']].". ".ucfirst($appointment_data['Doctor']['first_name'])." ".ucfirst($appointment_data['Doctor']['last_name'])."."?>
             
           ( ID:<strong><?= 'DOC-'.$appointment_data['Doctor']['registration_no']?></strong>)
           <br/>
