  ...
  <tbody>
    <tr>
      <td>
        ...
        <p>
            User <strong> <?= $salutations[$fetch_data['User']['salutation']]." ".ucfirst($fetch_data['User']['first_name'])." ".ucfirst($fetch_data['User']['last_name']); ?>
            </strong>
            has booked appointment <strong><?= $appointment_status[$status]; ?></strong> appointment
