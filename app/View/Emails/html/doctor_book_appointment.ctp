  ...
  <tbody>
    <tr>
      <td>
        ...
        <p>
            Doctor <strong><?= $salutations[$appointment_data['Doctor']['salutation']].". ".ucfirst($appointment_data['Doctor']['first_name'])." ".ucfirst($appointment_data['Doctor']['last_name'])?>
            </strong>
            has booked appointment
            <?php if(!empty($appointment_data['Service']['title'])) { ?>   
            for service <strong><?= $appointment_data['Service']['title'];?></strong> and 
            <?php } ?>
