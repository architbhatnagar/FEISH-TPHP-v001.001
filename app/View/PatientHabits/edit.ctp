...
<?php echo $this->Form->create('PatientHabit'); ?>
	<fieldset>
		<legend><?php echo __('Edit Patient Habit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PatientHabit.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PatientHabit.id'))); ?></li>
