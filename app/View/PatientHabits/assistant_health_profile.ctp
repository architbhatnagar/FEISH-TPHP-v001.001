                ...
                <div class="bhoechie-tab-content active">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <?php echo $this->HTML->link(__('<i class="fa fa-medkit"></i> Add Parameter'), array('controller' => 'patient_habits', 'action' => 'assistant_add_habits',$user['User']['id'], $user['User']['user_type']), array('id' => 'add_new_habit', 'escape' => false, 'class' => 'btn btn-danger btn-sm pull-right', 'style' => 'margin-top: -55px;')); ?>
                            <div class="box">
                                <div class="box-body">
