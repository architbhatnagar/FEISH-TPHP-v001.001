                ...
                <div class="bhoechie-tab-content active">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            Habit Parameters
                            <!--<a  class="btn btn-info pull-right" id="add_new_habit" href="<?= Router::url(array('controller' => 'patient_habits', 'action' => 'patient_add_habits', $user['User']['id'], $user['User']['user_type'])) ?>">Add Parameter</a>-->
                            <?php echo $this->HTML->link(__('<i class="fa fa-medkit"></i> Habbit List'), array('controller' => 'patient_habits', 'action' => 'patient_health_profile', $user['User']['id'], $user['User']['user_type']), array('id' => 'add_new_habit', 'escape' => false, 'class' => 'btn btn-danger btn-sm pull-right', 'style' => 'margin-top: -7px;')); ?>
                        </header>
                                                                                    ...
                                                                                    <div class="row">  
                                                                                        <div id="habit_<?= $habit['Habit']['id'] ?>">
                                                                                            <div class="col-lg-4">
                                                                                                <div class="row">
                                                                                                    <div class="col-lg-6">
                                                                                                        <input type="text" class="form-control mang" placeholder="Frequency" id="Frequency<?= $habit['Habit']['id'] ?>" value="<?= $already_habit_arr[$habit['Habit']['id']]['frequency'] ?>" name="habits[<?= $habit['Habit']['id'] ?>][frequency]">
                                                                                                    </div>

                                                                                                    <div class="col-lg-6">
                                                                                                        <?= $this->Form->input('unit', array('name' => 'habits[' . $habit['Habit']['id'] . '][unit]', 'empty' => 'Select Unit', 'options' => $units, 'id' => 'Unit' . $habit['Habit']['id'], 'class' => 'form-control mang', 'label' => false, 'selected' => $already_habit_arr[$habit['Habit']['id']]['unit'], "style" => "padding: -10px;")); ?>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>

                                                                                            <div class="col-lg-3">
                                                                                                <?= $this->Form->input('time_period', array('name' => 'habits[' . $habit['Habit']['id'] . '][time_period]', 'empty' => 'Select', 'options' => $time_period, 'id' => 'Time_period' . $habit['Habit']['id'], 'class' => 'form-control mang', 'label' => false, 'selected' => $already_habit_arr[$habit['Habit']['id']]['time_period'])); ?>
                                                                                            </div>
                                                                                            <div class="col-lg-2">
                                                                                                <?= $this->Form->input('habit_since', array('name' => 'habits[' . $habit['Habit']['id'] . '][habit_since]', 'empty' => 'Habit Since', 'options' => $habit_since, 'id' => 'Habit_since' . $habit['Habit']['id'], 'class' => 'form-control mang', 'label' => false, 'selected' => $already_habit_arr[$habit['Habit']['id']]['habit_since'])); ?>
                                                                                            </div>

                                                                                            <div class="col-lg-3">
                                                                                                <input type="checkbox" id="Is_stopped<?= $habit['Habit']['id'] ?>" name=" habits[<?= $habit['Habit']['id'] ?>][is_stopped]" class="is_stoped mang" habit_id="<?= $habit['Habit']['id'] ?>" value="1" <?php if ($already_habit_arr[$habit['Habit']['id']]['is_stopped'] == 1) { ?> checked="checked" <?php } ?>> Is Stopped?
                                                                                            </div>
                                                                                            <div class="col-lg-3" id="stp_date<?= $habit['Habit']['id'] ?>"  <?php if ($already_habit_arr[$habit['Habit']['id']]['is_stopped'] != 1) { ?>hidden <?php } ?>>
                                                                                                <label>When</label>
                                                                                                <input type="text" id="Stopped_date<?= $habit['Habit']['id'] ?>" name="habits[<?= $habit['Habit']['id'] ?>][stopped_date]" class="form-control mang habbit_date" placeholder="mm/dd/yyyy" value="<?= date('m/d/Y', strtotime($already_habit_arr[$habit['Habit']['id']]['stopped_date'])); ?>">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                    ...
                                                                                    <div class="row">  
                                                                                        <div id="habit_<?= $habit['Habit']['id'] ?>" hidden="">
                                                                                            <div class="col-lg-4">
                                                                                                <div class="row">
                                                                                                    <div class="col-lg-6">
                                                                                                        <input type="text" class="form-control mang" placeholder="Frequency" id="Frequency<?= $habit['Habit']['id'] ?>" name="habits[<?= $habit['Habit']['id'] ?>][frequency]">
                                                                                                    </div>

                                                                                                    <div class="col-lg-6">
                                                                                                        <?= $this->Form->input('unit', array('name' => 'habits[' . $habit['Habit']['id'] . '][unit]', 'empty' => 'Select Unit', 'options' => $units, 'id' => 'Unit' . $habit['Habit']['id'], 'class' => 'form-control mang', 'label' => false, "style" => "padding: -10px;")); ?>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>

                                                                                            <div class="col-lg-3">
                                                                                                <?= $this->Form->input('time_period', array('name' => 'habits[' . $habit['Habit']['id'] . '][time_period]', 'empty' => 'Select', 'options' => $time_period, 'id' => 'Time_period' . $habit['Habit']['id'], 'class' => 'form-control mang', 'label' => false)); ?>
                                                                                            </div>
                                                                                            <div class="col-lg-2">
                                                                                                <?= $this->Form->input('habit_since', array('name' => 'habits[' . $habit['Habit']['id'] . '][habit_since]', 'empty' => 'Habit Since', 'options' => $habit_since, 'id' => 'Habit_since' . $habit['Habit']['id'], 'class' => 'form-control mang', 'label' => false)); ?>
                                                                                            </div>
                                                                                            <div class="col-lg-3">
                                                                                                <input type="checkbox" id="Is_stopped<?= $habit['Habit']['id'] ?>" name=" habits[<?= $habit['Habit']['id'] ?>][is_stopped]" class="is_stoped mang" habit_id="<?= $habit['Habit']['id'] ?>" value="1"> Is Stopped?
                                                                                            </div>
                                                                                            <div class="col-lg-3" id="stp_date<?= $habit['Habit']['id'] ?>"  hidden>
                                                                                                <label>When</label>
                                                                                                <input type="text" id="Stopped_date<?= $habit['Habit']['id'] ?>" name="habits[<?= $habit['Habit']['id'] ?>][stopped_date]" class="form-control mang habbit_date" placeholder="mm/dd/yyyy">
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
