        ...
        <div class=" col-sm-12 bhoechie-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
                <div class="list-group">
                    ...
                    <a href="<?= Router::url(array('controller' => 'users', 'action' => 'assistant_purchased_plans', $user['User']['id'], $user['User']['user_type'])) ?>" class="list-group-item  text-center">
                    ...
                    <a href="<?= Router::url(array('controller' => 'diet_plans', 'action' => 'assistant_diet_plan', $user['User']['id'], $user['User']['user_type'])) ?>" class="list-group-item active text-center">
                ...
                <div class="bhoechie-tab-content">
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <a style="display: block;" href="<?= Router::url(array('controller' => 'diet_plans', 'action' => 'assistant_diet_plan',$user_id, $user_type)) ?>" class="btn btn-danger pull-right" id="cancel_add_new_family_history" hidden="">Cancel</a>
                        </header>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <?= $this->Form->input('start_date', array('type' => 'text', 'id' => 'start_date', 'class' => 'form-control', 'label' => false, 'data-bvalidator' => 'required', 'data-bvalidator-msg' => 'Please enter start date.', 'placeholder' => 'mm/dd/yyyy', 'value' => date('m/d/Y',  strtotime($diet_paln_details['DietPlan']['start_date'])), 'readonly' => true)); ?>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label class="control-label mll">End Date</label>
                                                                <?= $this->Form->input('end_date', array('type' => 'text', 'id' => 'end_date', 'class' => 'form-control', 'label' => false, 'data-bvalidator' => 'required', 'data-bvalidator-msg' => 'Please enter end date.', 'placeholder' => 'mm/dd/yyyy', 'value' => date('m/d/Y',  strtotime($diet_paln_details['DietPlan']['end_date'])), 'readonly' => true, 'onchange' => 'return checkValidDate()')); ?>
                                                            </div>
                                                        </div>
                                                    </div>
