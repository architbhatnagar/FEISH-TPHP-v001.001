                                                                ...
                                                                <table class="table table-bordered" id="appened_diet_tr_totable">
                                                                    ...
                                                                    <tbody>
                                                                        <tr id="tr0">
                                                                            ...
                                                                            <td>
                                                                                <input type="text" class="form-control timepicker" name="data[DietPlan][PlanDetails][0][time]" id="sl_time" data-bvalidator="required"  data-bvalidator-msg = "Please enter time."  placeholder = "Time"/>
                                        ...
                                        foreach ($diet_plan_arr as $diet_plan) :
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= Router::url(array('controller' => 'diet_plans', 'action' => 'assistant_edit_diet_plan', $diet_plan['DietPlan']['id'], $user['User']['id'], $user['User']['user_type'])) ?>" class="btn btn-primary btn-xs" title="View"><i class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        endforeach;
