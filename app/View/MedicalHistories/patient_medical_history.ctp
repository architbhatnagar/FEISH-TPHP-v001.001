        ...
        <div class=" col-sm-12 bhoechie-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
                <div class="list-group">
                    ...
                    <a href="<?= Router::url(array('controller' => 'medical_histories', 'action' => 'patient_medical_history', $user['User']['id'], $user['User']['user_type'])) ?>" class="list-group-item active text-center">
                    ...
                    <section class="panel">
                        <header class="panel-heading">
                            ...
                            <?php if(Authcomponent::user('user_type') != 1) { ?>
                                <a class="btn btn-info pull-right" id="add_new_family_history" style="display: block;">Add </a>
                                <a class="btn btn-danger pull-right" id="cancel_add_new_family_history" hidden="" style="display: none;">Cancel</a>
                            <?php } ?>
                        </header>
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <?php echo $this->Form->create('MedicalHistory', array('action' => 'patient_update_medical_history', 'name' => "add_medical_history", 'id' => "add-medical-history")); ?>
