...
<?php echo $this->Form->create('LabTestResult'); ?>
	<fieldset>
		<legend><?php echo __('Edit Lab Test Result'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LabTestResult.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('LabTestResult.id'))); ?></li>
