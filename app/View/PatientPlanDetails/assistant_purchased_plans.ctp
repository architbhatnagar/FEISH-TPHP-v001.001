                            ...
                            <div class="col-lg-4">
                                <div class="pricing-table most-popular">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                ...
                                                <?php if (strlen($plan_details[0]) <= 25) { ?>
                                                    <a title="View" href="<?= Router::url(array('controller' => 'patient_plan_details', 'action' => 'assistant_view_plan', $plan['PatientPackageLog']['id'], $user['User']['id'], $user['User']['user_type'])) ?>">
                                                        <?php
                                    ...
                                    <div class="price-actions">
                                        <a href="<?= Router::url(array('controller' => 'patient_plan_details', 'action' => 'assistant_view_plan', $plan['PatientPackageLog']['id'], $user['User']['id'], $user['User']['user_type'])) ?>" class="btn btn-danger" role="button">View</a>
                                    </div>
                                </div>
                            </div>
                            <?php
