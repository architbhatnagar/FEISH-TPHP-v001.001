            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 bhoechie-tab">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <?php echo $this->HTML->link(__('<i class="fa fa-medkit"></i>Plan List'), array('action' => 'patient_purchased_plans',$user['User']['id'], $user['User']['user_type']), array('id' => 'add_treatment', 'escape' => false, 'class' => 'btn btn-danger btn-sm pull-right', 'style' => 'margin-top: -55px;')); ?>
                        <div class="row">
                            <div class="col-md-6">
