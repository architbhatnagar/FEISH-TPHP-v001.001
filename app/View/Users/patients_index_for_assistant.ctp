                            ...
                            <tr>
                                ...
                                <td class="actions"> 
                                    ...
                                    <?php elseif (in_array($user['User']['user_type'], array(4, 5))): ?>
                                        <?php echo $this->Html->link(__(''), array('controller' => 'patient_habits','action' => 'assistant_health_profile', $user['User']['id'], $user_type), array('class' => 'btn btn-sm btn-primary fa fa-eye popovers', 'data-content' => 'View', 'data-placement' => 'bottom', 'data-trigger' => 'hover')); ?>
