                ...
                <div class="section-content">
                    <div style="padding-bottom: 70px" class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="box mbn">
                                <div class="box-heading"> <h1>User Agreement and Privacy Policy</h1></div>
                                <div class="box-body">
                                    <ol class="contents">

                                        <li><a href="#introduction">INTRODUCTION</a></li>

                                        <li><a href="#monitor">MONITORING AND COMPLAINTS AGAINST OTHER USERS</a></li>

                                        <li><a href="#registration_top">REGISTRATION AND ACCOUNT/PROFILE CREATION
                                        ...
                                        <li><a href="#senstitive">SENSITIVE INFORMATION DISCLAIMER</a></li>
                                        ...
                                        <li><a href="#rules">RULES OF USAGE</a>
                                            ...
                                            <ol class="b">
                                                ...
                                                <li><a href="#comments">Comments on the Service are not Necessarily Endorsed by Us</a></li>

                                                <li><a href="#use_content">Use of Content Supplied by You</a></li>

                                                <li><a href="#editing">Editing, Additions, and Deletions</a></li>

                                                <li><a href="#copyright_complaint">Copyright Complaints</a></li>

                                                <li><a href="#merchandise">Merchandise, Products and/or Services Available on or through the Service</a></li>

                                                <li><a href="#indemnification">Indemnification</a></li>

                                                <li><a href="#disclaimer">Disclaimer of Warranty and Limitation of Liability</a></li>

                                                <li><a href="#termination">Termination or Suspension of the Service, Your Use of the Service, and/or the Agreement</a></li>

                                                <li><a href="#communications">Communications to You</a></li>

                                                <li><a href="#associated_press">Associated Press</a></li>

                                                <li><a href="#mobile_participants">Mobile Participants</a></li>

                                                <li><a href="#disputes">Disputes and Jurisdiction</a></li>
                                        ...
                                        <li><a href="#privacy">PRIVACY POLICY</a>
                                            ...
                                            <ol class="b">
                                                ...
                                                <li><a href="#type_information">The Type of Information the Service Collects</a></li>

                                                <li><a href="#information_use">How the Service Uses Information About You</a></li>

                                                <li><a href="#local_storage">Local Device Storage and other Tracking Technologies</a></li>

                                                <li><a href="#opt_out">How to Opt-Out of Third Party Tracking Technologies</a></li>

                                                <li><a href="#transfer">Transfer of Information</a></li>

                                                <li><a href="#information_security">Information Security and Notification</a></li>

                                                <li><a href="#kids_parents">Kids and Parents</a></li>

                                                <li><a href="#policy_coordinator">Privacy Policy Coordinator</a></li>
                                    ...
                                    <ol>
                                        ...
                                        <li><h2><a id="introduction"></a>INTRODUCTION</h2>

                                            <P>This User Agreement and Privacy Policy governs each website, mobile site, application, and/or other service, regardless of how distributed, transmitted, published, or broadcast (each, a "Service") provided by Advance Publications, Inc., its parent, subsidiaries and/or affiliates ("we," "us," or "our") that links to this User Agreement and Privacy Policy, which is binding on all those who access, visit and/or use the Service, whether acting as an individual or on behalf of an entity, including you and all persons, entities, or digital engines of any kind that harvest, crawl, index, scrape, spider, or mine digital content by an automated or manual process or otherwise (collectively, "you" or "your").</p>

                                            <p>Please read this User Agreement and Privacy Policy carefully. You can access this User Agreement and Privacy Policy any time in the footer of the Service's home page or initial screen. <strong>Your access, visitation and/or use of the Service, including without limitation any registration on any aspect of the Service, will constitute your agreement to this User Agreement and Privacy Policy.</strong> If you do not agree with the terms and conditions of this User Agreement and Privacy Policy, you may not access, visit and/or use the Service.</p>

                                            <p>The User Agreement and Privacy Policy may be modified from time to time; the date of the most recent revisions will appear on this page, so check back often. Continued access of the Service by you will constitute your acceptance of any changes or revisions to the User Agreement and Privacy Policy. 
                                        ...
                                        <li><h2><a id="monitor"></a>MONITORING AND COMPLAINTS AGAINST OTHER USERS</h2>
                                            ...
                                            <ol class="b">
                                                ...
                                                <li><h3><a id="complaint"></a>What to Do if You Have a Complaint Against Another User</h3>
                                                    ...
                                                    <ol class="c">
                                                        ...
                                                        <li>Remember that by using the publicly accessible portions of our Service you may be exposed to Content that is opinionated, offensive, and/or inappropriate, including Content that violates the Agreement, but not all of such Content is actionable.  We ask that you not use the Service, or lodge complaints against other users, to facilitate a personal dispute.  If you have a legitimate complaint about another user, please do the following:
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>Harassment:  If you have reason to believe that another person is using the Service in a way that is harmful to you (e.g., to impersonate or imitate you, or to stalk, bully, threaten, intimidate or otherwise harass you), we urge you to contact your local authorities, or appropriate state or federal agencies.</li>

                                                                <li>Copyright Complaints:  If you have reason to believe that your Content has been copied and/or is accessible on the Service in a way that constitutes copyright infringement, or that the Service contains links or other references to another site, application, destination or service that contains Content or activity that infringes your copyright rights, you may notify us as described below in the section entitled <a href="#copyright_complaint">Copyright Complaints</a>.</li>
                                                        ...
                                                        <li>IMPORTANT: FALSE OR INACCURATE ACCUSATIONS THAT OTHERS HAVE COMMITED A CRIME, INAPPROPRIATE ACT, OR VIOLATION OF THIS AGREEMENT, COULD BE A VIOLATION OF CRIMINAL AND/OR CIVIL LAW, OR OTHERWISE EXPOSE YOU TO LIABILITY FOR DAMAGES (INCLUDING COSTS AND ATTORNEYS' FEES).</li>
                                            ...
                                            <ol class="b">
                                                ...
                                                <li><h3><a id="fees"></a>Fees and Payments:</h3>
                                                    ...
                                                    <ol class="c">
                                                        ...
                                                        <li>In addition, you are responsible for obtaining and maintaining at your own expense all equipment, hardware, software, and telephone, mobile, wireless, Internet and other services necessary to access, visit and/or use the Service.  If you are accessing the Service via a mobile device, your mobile carrier may charge you fees for data, text messaging, and other mobile access or communications services.</li>
                                        ...
                                        <li><h3><a id="senstitive"></a>SENSITIVE INFORMATION DISCLAIMER</h3>

                                            <ol class="c">

                                                <li>While you may freely discuss topics of interest to you, and the Service may include general Content relating to a range of topics, including medical, health, legal, tax, or financial issues, you should not rely on the Service for individual advice on such issues.  Instead, we recommend that you talk in person with a qualified professional. You alone will bear the sole responsibility for evaluating the merits and/or risks associated with use of Content obtained on or through this Service before making any decisions based on such Content.</li>

                                                <li>THE CONTENT AVAILABLE ON OR THROUGH THIS SERVICE IS IN NO WAY INTENDED TO AND SHALL NOT BE CONSTRUED TO: (A) CONSTITUTE PROFESSIONAL MEDICAL, HEALTH, LEGAL, TAX, OR FINANCIAL ADVICE; (B) RECOMMEND, ENDORSE, OR ADVISE REGARDING ANY FINANCIAL INSTRUMENT OR INVESTMENT STRATEGY; OR (C) DIAGNOSE, CURE, OR TREAT ANY MEDICAL, HEALTH OR OTHER CONDITION. ALWAYS SEEK THE ADVICE OF A QUALIFIED PROFESSIONAL. FOR EXAMPLE, SEEK THE ADVICE OF YOUR PHYSICIAN OR OTHER QUALIFIED HEALTH PROVIDER PRIOR TO STARTING ANY NEW DIET AND ASK YOUR DOCTOR ANY QUESTIONS YOU MAY HAVE REGARDING A MEDICAL CONDITION. IN ADDITION TO ALL OTHER LIMITATIONS AND DISCLAIMERS IN THE AGREEMENT, WE AND OUR LICENSORS, VENDORS, AND/OR SERVICE PROVIDERS DISCLAIM ANY LIABILITY OR LOSS IN CONNECTION WITH THE CONTENT OBTAINED ON OR THROUGH THIS SERVICE.</li>

                                            </ol>

                                        </li>

                                        <li><h2><a id="rules"></a>RULES OF USAGE:</h2>

                                            <ol class="b">

                                                <li><h3><a id="use_of_service"></a>Use of the Service by You:</h3>

                                                    <ol class="c">

                                                        <li>The Service is not intended for users under the age of 13, and we do not knowingly collect personally identifiable information from users under the age of 13. Such users are expressly prohibited from registering for the Service or submitting their personally identifiable information to us, and from using portions of the Service for which registration is required, such as our social, community and public discussion areas, photo and video galleries, bulletin boards, forums, chats, blogs, personal/job search and other classified ads, contests/sweepstakes, and elsewhere.</li>

                                                        <li>You shall ensure that all equipment, hardware, software, products and/or services you use to access, visit, or use the Service does not disturb or interfere with our operation of the Service, or impede or interfere with others' access, visitation and/or use of the Service. We reserve the right, in addition to our other remedies, with or without notice, to immediately disconnect from the Service any equipment, hardware, software, product and/or services causing interference with us, our licensors, vendors, service providers, the Service or any Content.</li>

                                                        <li>If you provide to us the number for a mobile or other device, or we obtain the device identifier for a device you are using, you agree, represent, warrant, and guarantee that such device is registered in your name and owned by you, or that you have permission of the device owner(s).</li>

                                                        <li>Unless otherwise specified, the Service is intended for your personal, non-commercial use only.  You are solely responsible for all usage of, or activities on, the Service by you and by those you authorize or allow to use, or provide access to, the Service, for example, by authorizing or allowing access to your account/profile or any computer, mobile or other device on which the Service resides or is accessible.</li>
                                                        ...
                                                        <li>Content that is provided by us, our licensors, vendors and/or service providers, including without limitation photos, images, text, music, audio, videos, podcasts, trademarks, trade names, service marks and other brand identifiers, the organization, design, compilation, and "look and feel" of the Service, and all advertising thereon, is protected by local, state, federal, provincial, national, international, and foreign copyright, trademark and other intellectual property laws, rules, and regulations, and is the property of us or our licensors, vendors and/or service providers.</li>

                                                        <li>Certain Content may be made available to you on or through the Service for download, installation, and/or streaming on your computer, mobile or other device, and via Real Simple Syndication (RSS), such as photos, images, text, music, audio, videos, podcasts, ringtones, games, graphics, or software.  Such Content is subject to the same terms, conditions, limitations and restrictions applicable to all Content provided by us, our licensors, vendors and/or service providers.  You must, in addition to all of your other obligations, use such Content only to the extent expressly authorized for the particular Content, and you may not use such Content in a manner that exceeds such authorization.</li>

                                                    </ol>

                                                </li>

                                                <li><h3><a id="use_prohibitions"></a>Prohibitions on Use of the Service:</h3>
                                                ...
                                                <li><h3><a id="comments"></a>Comments on the Service are Not Necessarily Endorsed by Us:</h3>
                                                ...
                                                <li><h3><a id="use_content"></a>Use of Content Supplied by You:</h3>

                                                    <ol class="c">

                                                        <li>To learn about our use of information about you and your computer, mobile or other device that may be collected in connection with your access, visitation and/or use of the Service, please see our <a href="#privacy">Privacy Policy.</a></li>
                                                ...
                                                <li><h3><a id="editing"></a>Editing, Additions and Deletions:</h3>
                                                        ...
                                                        <li><strong>Copyright Agent:</strong><br>
                                                            <div id="contact">
                                                                <table border=0>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>Jerry Birenz, Esq.</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Sabin, Bermant & Gould LLP</td>
                                                                            <td>Phone: (212) 381-7057</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>One World Trade Center, 44th Floor</td>
                                                                            <td>Fax: (212) 381-7201</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>New York, NY 10007-2915 </td>
                                                                            <td>E-mail: <a href="mailto:copyright@sabinfirm.com">copyright@sabinfirm.com</a></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table> 
                                                            </div>
                                                            ...
                                                            <p>For communications on other matters, please contact us through the means described on the Service, if available (for example, in the "Contact Us" section), or if no such means are specified, contact our Privacy Policy Coordinator as described in our <a href="#privacy">Privacy Policy.</a></p>
                                                ...
                                                <li><h3><a id="communications"></a>Communications to You:</h3>
                                            ...
                                            <ol class="b">
                                                ...
                                                <li><h3><a id="information_use"></a>How the Service Uses Information About You:</h3>
                                                    ...
                                                    <ol class="c">
                                                        ...
                                                        <li>We reserve the right to access, use, and share with others your personally identifying information for purposes of health, safety and other matters in the public interest.</li>

                                                        <li>We may also provide access to our database in order to cooperate with official investigations or legal proceedings initiated by governmental and/or law enforcement officials, as well as private parties, including, for example, in response to subpoenas, search warrants, court orders, or other legal process.</li>

                                                        <li>In addition, we reserve the right to use the information we collect about your computer, mobile or other device (including its geographic location), which may at times be able to identify you, for any lawful business purpose, including without limitation to help diagnose problems with our servers, to gather broad demographic information, analyze trends, track users' movements around the Service, and to otherwise administer the Service.  Geographic location information about you and/or your computer, mobile or other device may specifically be used to show you content and sponsored messaging based on geographic location.</li>

                                                        <li>We reserve the right to use, transfer, sell, and share aggregated, anonymous data about our users as a group for any lawful business purpose, such as analyzing usage trends and seeking compatible advertisers, sponsors, clients and customers.</li>
                                                        ...
                                                        <li>We reserve the right to identify you from your Registration Information and/or to merge or co-mingle anonymous or non-personally identifiable data about you, your offline and online behavior, and/or your computer, mobile or other device (including its geographic location), with your Registration Information and/or other personally identifiable data for any lawful business purpose.</li>

                                                    </ol>

                                                </li>

                                                <li><h3><a id="local_storage"></a>Local Device Storage and other Tracking Technologies; Do Not Track (DNT):</h3>

                                                    <ol class="c">

                                                        <li>The Service will at times place and/or store code or other types of information and/or devices (e.g., "cookies") on your computer, mobile or other device ("Local Device Storage"). We may use Local Device Storage for any lawful business purpose, including without limitation to determine which of our messages have been opened by recipients so we can gauge the effectiveness of marketing campaigns, to control the display of ads, to track usage patterns, the movements of individual users, and your geographic location, to help diagnose problems with our servers, to gather broad demographic information, to analyze trends, to conduct research, to deliver editorial content, to record registration and personalization information, and to otherwise administer the Service.  For example, if you register on any part of the Service and are given the option to save your user name and password, we may provide this convenience to you via Local Device Storage.  Local Device Storage may also collect and store your personally identifiable information, which may be shared with our parent, subsidiaries, and affiliates and other companies.</li>

                                                        <li>If you do not want Local Device Storage, your computer, mobile or other device may include an option that allows you to not accept it. However, if you disable Local Device Storage, some portions of the Service may not function properly.</li>

                                                        <li>In addition to Local Device Storage, we may use web beacons, web bugs, clear gifs, and similar technologies (collectively, together with Local Device Storage, the "Tracking Technologies").  We use Tracking Technologies for all or some of the same lawful business purposes we describe above for use of Local Device Storage.</li>

                                                        <li>As discussed below, you may opt out of third party tracking on the Service at any time.  However, we do not currently support any browser based Do Not Track (DNT) settings or participate in any DNT frameworks, and we do not assign any meaning to any potential DNT track signals you may send or alter any of our data collection or use practices in response to such signals.</li>

                                                    </ol>

                                                </li>

                                                <li><h3><a id="opt_out"></a>How to Opt-Out of Third Party Tracking Technologies:</h3>
                                                ...
                                                <li><h3><a id="transfer"></a>Transfer of Information:</h3>
                                                ...
                                                <li><h3><a id="information_security"></a>Information Security and Notification:</h3>
                                                    ...
                                                    <ol class="c">
                                                        ...
                                                        <li>Moreover, if you elect to store information, such as your personally identifiable information or other Registration Information, where others may access it, we are not responsible for any loss of such information or the consequences thereof.  If you lose a computer, mobile or other device, or it is stolen, that contains your personally identifiable information or other Registration Information, it is up to you to take all the steps necessary to protect yourself.</li>

                                                        <li>In the unlikely event that we believe that the security of your information in our possession or control may have been compromised, we may seek to notify you. If notification is appropriate, we may notify you via your computer, mobile or other device.</li>

                                                    </ol>

                                                </li>

                                                <li><h3><a id="kids_parents"></a>Kids and Parents:</h3>

                                                    <ol class="c">

                                                        <li>This Service is not intended for use by children, especially those under age 13. No one under age 13 is allowed to register for the Service or provide any personally identifiable information or use our social, community and public discussion areas, photo and video galleries, bulletin boards, forums, chats, blogs, personal/job search and other classified ads, and elsewhere. Minors between the ages of 13 and 17, inclusive, must get the permission of their parent(s) or legal guardian(s) before making purchases, including subscriptions, on this Service.</li>

                                                        <li>If your children disclose information about themselves in publicly accessible areas of the Service, they may get unsolicited messages from other parties. Accordingly, you should tell them not to do so.</li>

                                                        <li>If you're worried about your children's activities or their privacy on the Service, we encourage you to contact our Privacy Policy Coordinator as described below.</li>

                                                    </ol>

                                                </li>

                                                <li><h3><a id="policy_coordinator"></a>Privacy Policy Coordinator:</h3>

                                                    <p>If you have any concerns or questions about any aspect of this policy, please feel free to contact our Privacy Policy Coordinator as follows:</p>

                                                    <div id="address">Privacy Policy Coordinator<br>

                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Advance Digital, Inc.<br>

                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Harborside Financial Center<br>

                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Plaza 5, 31st Floor<br>

                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jersey City, NJ 07311-4034<br>

                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="mailto:privacy_inquiry@advance.net">privacy_inquiry@advance.net</a></div>

                                                    <p style="font-weight:bold">Make sure to include enough information for us to help you, including for example your name, contact information, and the specific website, mobile site, application, and/or other service you're contacting us about.</p>

                                                    <p style="font-weight:bold">Note: Only inquiries about this policy or your personal information should be sent to the Privacy Policy Coordinator. No other communications will be accepted or responded to.</p>

                                                    <p>For communications on other matters, please contact us through the means described on the Service, if available (for example, in the "Contact Us" section).</p>
                                                </li>
                                            </ol>
                                        </li>
                                    </ol>
                                    ...
                                    <h3>If you don't agree to the terms contained in this User Agreement and Privacy Policy, you must immediately exit the Service.</h3>
