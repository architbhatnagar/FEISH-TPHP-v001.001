<div class="row">
    <div class="col-sm-12">
        <ul class="breadcrumbs-alt">
            ...
            <li class="pull-right">
                <a class="active-trail current  goBack" href="<?php echo $previous_url; ?>"><i class="fa fa-backward"></i> &nbsp;Back</a>                
                <!--<a class="active-trail current  goBack" href="<?= Router::url(array('controller' => 'users', 'action' => 'doctors_dashboard')) ?>"><i class="fa fa-backward"></i> &nbsp;Back else</a>-->
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <?php elseif (in_array($user['User']['user_type'], array(4, 5))): ?>
                                            <?php echo $this->Html->link(__(''), array('controller' => 'users', 'action' => 'admin_patient_view', $user['User']['id']), array('class' => 'btn btn-sm btn-primary fa fa-eye popovers', 'data-content' => 'View', 'data-placement' => 'bottom', 'data-trigger' => 'hover')); ?>
