...
<?php echo $this->Form->create('VitalSign'); ?>
	<fieldset>
		<legend><?php echo __('Edit Vital Sign'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('VitalSign.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('VitalSign.id'))); ?></li>
