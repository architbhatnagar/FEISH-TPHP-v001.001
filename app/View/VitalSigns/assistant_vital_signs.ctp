        ...
        <div class=" col-sm-12 bhoechie-tab-container">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 bhoechie-tab-menu">
                <div class="list-group">
                    ...
                    <a href="<?= Router::url(array('controller' => 'vital_signs', 'action' => 'assistant_vital_signs', $user['User']['id'], $user['User']['user_type'])) ?>" class="list-group-item active text-center">
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <?php echo $this->Form->create('VitalSign', array('action' => 'assistant_update_vital_sign', 'name' => 'add_vital_sign_form', 'id' => 'add_vital_sign_form')); ?>
